                        ...
                        <div className='row brown lighten-3 no-bottom-margin'>
                            <div className='col m12'>
                                ...
                                <ul>
                                    ...
                                    <li><i className="fa-solid fa-location-dot"></i>Centennial, CO</li>
                                    <li><i className="fa-brands fa-github"></i>github.com/DanielMrva</li>
                                    <li><i className="fa-brands fa-linkedin"></i>linkedin.com/in/daniel-mrva/</li>
                                </ul>
